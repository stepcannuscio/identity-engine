...
def inspect_security_posture() -> dict[str, object]:
    ...
    checks = [
        SecurityCheck(
            ...
            recommendation="Enable FileVault and keep recovery access documented safely.",
        ),
        SecurityCheck(
            ...
            recommendation="Prefer a personal/local recovery key over escrow-only recovery when possible.",
        ),
        SecurityCheck(
